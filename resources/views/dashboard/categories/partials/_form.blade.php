...
<div>
    ...
    <p class="mt-2 text-sm text-gray-500">Brief description for the category. (<i class="italic">for
            header and social media </i>)</p>
</div>

<div>
    <label for="body" class="block text-sm font-medium text-gray-300">Main content </label>
    <div class="mt-1">
...
<div class="flex gap-x-4">
    ...
    <div class="w-1/2">
        <label for="popular" class="block text-sm font-medium text-gray-300">Popular</label>
    ...
    <div class="w-1/2">
        <label for="live" class="block text-sm font-medium text-gray-300">Is Live</label>
