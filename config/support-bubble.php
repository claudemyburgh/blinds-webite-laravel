...
return [
     ...
     */
    'classes' => [
        'container' => 'text-base items-end z-30 flex-col m-4 gap-3 rounded-md',
        'bubble' => 'hidden sm:block bg-primary-400 rounded-full shadow-lg w-14 h-14 text-white p-4',
        'input' => 'bg-gray-100 border border-gray-200 w-full max-w-full p-2 rounded-md shadow-input text-gray-800 text-base',
        'button' => 'inline-flex rounded-md place-center px-4 py-3 h-10 border-0 bg-primary-500 hover:bg-primary-600 active:bg-primary-600 overflow-hidden rounded-sm text-white leading-none no-underline',
    ],
